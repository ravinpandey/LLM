...
class NeuralNet(nn.Module):
    def __init__(self, input_size, hidden1, hidden2,hidden3,hidden4, num_classes):
        ...
        self.relu4 = nn.ReLU()
        self.l5 = nn.Linear(hidden4,num_classes)
...
model = NeuralNet(input_size=784, hidden1=100, hidden2=75, hidden3=50,hidden4=25 ,num_classes=10).to(device)
# Loss and optimizer
